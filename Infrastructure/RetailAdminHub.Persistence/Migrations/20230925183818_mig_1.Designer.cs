...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailAdminHub.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RetailAdminHub.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("RetailAdminHub.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RetailAdminHub.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("RetailAdminHub.Domain.Entities.Endpoint", null)
                        .WithMany()
                        .HasForeignKey("EndpointsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RetailAdminHub.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RetailAdminHub.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RetailAdminHub.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("RetailAdminHub.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
